...
public class BSTIteration extends LocalJavaAnimation {
	...
	public BSTIteration() {
		...
		super("Iteration over Binary Search Trees");
	}

	@Override
	public String about() {
		return "Demonstration of binary search tree iteration,\n" +
		"prepared for CS 361, \n" +
	...
	boolean displayParentPointers = true;
	...
	class BinaryTreeRendering implements Renderer<BinarySearchTree<Integer>> {
	   ...
	   class IteratorRendering implements Renderer<BinarySearchTree<Integer>.BstIterator> {

	        @Override
	        public Color getColor(BinarySearchTree<Integer>.BstIterator obj) {
	            return null;
	        }

	        @Override
	        public List<Component> getComponents(BinarySearchTree<Integer>.BstIterator iter) {
	            LinkedList<Component> comps = new LinkedList<Component>();
	            comps.add (new Component(new SimpleReference(iter.tree, 60, 85), "tree"));
                comps.add (new Component(new SimpleReference(iter.nodePtr, 95, 120), "nodePtr"));
	            return comps;
	        }

	        @Override
	        public List<Connection> getConnections(BinarySearchTree<Integer>.BstIterator obj) {
	            return new LinkedList<Connection>();
	        }

	        @Override
	        public int getMaxComponentsPerRow(BinarySearchTree<Integer>.BstIterator obj) {
	            return 1;
	        }

	        @Override
	        public String getValue(BinarySearchTree<Integer>.BstIterator obj) {
	            return "";
	        }
	...
	{ 
		if (element < t.element) 
		{
			...
			{
				t.left = new BinaryNode<Integer>(element, null, null, t);
			}
		} 
		else
		{
			...
			{
				t.right = new BinaryNode<Integer>(element, null, null, t);
			}
		} 
	...
	BinarySearchTree<Integer>.BstIterator current = bst.quickEnd();
	...
	public void buildMenu() {
		...
		registerStartingAction(new MenuFunction() {
			...
			public void selected() {
                ...
                getMemoryModel().getActivationStack().render(BinarySearchTree.BstIterator.class, new IteratorRendering());
			}
		...
		register("iter = tree.begin()", new MenuFunction() {
		...
		register("iter = tree.end()", new MenuFunction() {
		...
		register("iter = tree.find(...)", new MenuFunction() {
	...
	public static void main (String[] args) {
		BSTIteration demo = new BSTIteration();
		demo.runAsMain();
	}
