...
public class CS361SortingAnimationNew extends LocalJavaAnimation {

	public CS361SortingAnimationNew() {
	...
	public void buildMenu() {
		...
		register ("Insertion Sort", new MenuFunction() {
			@Override
			public void selected() {
				new SortingNew().insertionSort (array, array.length);
			}
		});
		...
		register ("Shell Sort", new MenuFunction() {
			@Override
			public void selected() {
				new SortingNew().shellSort (array, array.length);
			}
		});
	...
	public static void main (String[] args) {
		CS361SortingAnimationNew demo = new CS361SortingAnimationNew();
		demo.runAsMain();
	}
